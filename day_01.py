...
def find_2020(report):
    for i, expense_a in enumerate(report):
        for expense_b in report[i + 1:]:
            if expense_a + expense_b == 2020:
                return expense_a * expense_b


def find_2020_3(report):
    for i, expense_a in enumerate(report):
        for j, expense_b in enumerate(report[i + 1:]):
            for k, expense_c in enumerate(report[j + 1:]):
